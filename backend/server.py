...
**OUTPUT:** A single, high-resolution JPEG image suitable for a high-end eBay listing."""
        ...
        # No fallback - if it doesn't work, return None
        logging.warning("No images generated by Gemini - image optimization failed")
        return None
        ...
        if "quota" in error_str or "limit" in error_str or "429" in str(e):
            logging.error("Gemini API quota exceeded for image processing")
        ...
        # NO FALLBACK - return None if image processing fails
        return None
